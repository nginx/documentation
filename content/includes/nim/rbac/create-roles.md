...
- content/nim/authentication/oidc/keycloak-setup.md
- content/nim/authentication/oidc/microsoft-entra-setup.md
- content/nim/rbac/create-roles.md
- content/nim/security-monitoring/give-access-to-security-monitoring-dashboards.md
---

Roles in NGINX Instance Manager are a critical part of [role-based access control (RBAC)]({{< ref "/nim/rbac/overview-rbac.md" >}}). By creating roles, you define the access levels and permissions for different user groups that correspond to groups in your Identity Provider (IdP).
...
1. To add permissions:
   ...
   3. Select the feature you're granting permission for from the **Feature** list. To learn more about features, refer to [Get started with RBAC]({{< ref "/nim/rbac/overview-rbac.md" >}}).
