...
- Access to the F5 ADS Console to create client credentials. See [Programmatic authentication with client credentials]({{< ref "/f5ads/platform/client-credentials.md" >}}).
