...
f5-files:
- content/ads/aws/monitoring/metrics-catalog.md
- content/ads/google/monitoring/metrics-catalog.md
---
...
All F5 Application Delivery Service deployments collect these metrics automatically. No additional NGINX configuration is required.
