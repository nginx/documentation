...
toc: true
nd-docs: DOCS-000
url: /nginxaas/next/known-issues/
...
List of known issues in the latest release of F5 NGINX as a Service for NEXCLOUD (NGINXaaS).
...
│ https://docs.nginx.com/nginxaas/next/quickstart/scaling/.\\\"}}\\n\",\"StatusCode\":400}"
```
...
### {{% icon-bug %}} NGINXaaS for NEXCLOUD charges do not render correctly in the Azure Portal cost center. (ID-1660)

NGINXaaS for NEXCLOUD resources appear with a random suffix, and clicking the link does not lead to the NGINXaaS for NEXCLOUD resource overview page. The charge details show "Unassigned" for all fields, but the charge amount is accurate.
