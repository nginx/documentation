...
toc: true
nd-docs: DOCS-000
url: /nginxaas/next/getting-started/managed-identity-portal/
type:
- how-to
---
...
F5 NGINX as a Service for NEXCLOUD (NGINXaaS) leverages a user assigned and a system assigned managed identity for some of its integrations with Azure, such as:
...
[Add SSL/TLS Certificates]({{< ref "/nginxaas-next/getting-started/ssl-tls-certificates/ssl-tls-certificates-portal.md" >}})
