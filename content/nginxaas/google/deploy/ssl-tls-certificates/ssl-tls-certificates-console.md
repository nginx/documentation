...
- Subscribe to the NGINXaaS for Google Cloud offer. See [Subscribe to the NGINXaaS for Google Cloud offer]({{< ref "/nginxaas/google/deploy/prerequisites.md" >}}).
- Create a deployment. See [Deploy using the console]({{< ref "/nginxaas/google/deploy/create-deployment/deploy-console.md" >}}).
