...
- If you haven't done it yet, follow the steps in the [Prerequisites]({{< ref "/nginxaas/google/deploy/prerequisites/" >}}) topic to subscribe to the NGINXaaS for Google Cloud offer in the Google Cloud Marketplace.
