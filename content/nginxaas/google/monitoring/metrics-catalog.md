...
F5 Application Delivery Service for Google Cloud (ADS) provides a rich set of metrics that you can use to monitor the health and performance of your F5 ADS deployment. This document provides a catalog of the metrics that are available for monitoring F5 ADS.

The following metrics are reported by F5 ADS in Google Cloud Monitoring.
