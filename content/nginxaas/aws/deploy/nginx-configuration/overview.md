...
weight: 50
toc: true
url: /nginxaas/aws/deploy/nginx-configuration/overview/
...
F5 NGINXaaS for AWS deployment, restrictions, and available directives.

## NGINX configuration common user workflows

You can upload NGINX configurations to your NGINXaaS for AWS deployment using the AWS Management Console:

- [Upload using the console]({{< ref "/nginxaas/aws/deploy/nginx-configuration/nginx-configuration-console.md" >}})
...
If you need access to additional directories, please [contact us]({{< ref "/nginxaas/aws/support.md" >}}).
