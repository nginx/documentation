...
* The hourly rate in East US 2 is `$0.03 USD/NCU/hour`.
* 9:00 hour: `20 NCU·hour`
* 10:00 hour: `20 NCU·hour`
* Total NCU·hours: `40 NCU·hour`
* Total: `40 NCU·hour * $0.03 USD/NCU/hour = $1.20 USD`.
...
* The hourly rate in West Europe is `$0.05 USD/NCU/hour`.
* 9:00 hour: `40 NCU·hour`
* 10:00 hour: `40 NCU·hour`
* 11:00 hour: `20 NCU·hour`
* Total NCU·hours: `100 NCU·hour`
* Total:  `100 NCU·hours * 0.05/NCU/hour = $5.00 USD`.
...
* To learn more about metrics related to NCUs, see the [NGINXaaS Statistics namespace]({{< ref "/nginxaas-azure/monitoring/metrics-catalog.md#nginxaas-statistics" >}}){{< /call-out >}}
...
{{< call-out "note" >}}The management traffic for NGINX instances is billed as a `Virtual Network Peering - Intra-Region Egress` charge. This charge includes the data for shipping metrics and logs. The cost for shipping metrics data is approximately $0.03 USD/month. If you enable NGINX logging the cost increases by roughly $0.005 USD per GB of logs NGINX generates. To estimate this, multiply the number of requests by the average log line size of the access_log format you have configured.
{{< /call-out >}}
