...
{{< call-out "important" >}}**System-Assigned Managed Identity Required**: The system-assigned managed identity is automatically created during deployment and is required for all NGINXaaS deployments. It cannot be removed.{{< /call-out >}}
