...
- [Enable NGINX logs](https://docs.nginx.com/nginxaas/azure/monitoring/enable-logging/)
- [Enable monitoring](https://docs.nginx.com/nginxaas/azure/monitoring/enable-monitoring/)
