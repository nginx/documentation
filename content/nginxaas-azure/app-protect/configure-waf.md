...
- Enter the **Name**, **File path**, your policy content, and then select **Save**. 

    - Be sure to append the **File path** with ".json". 
    - The **File path** must be set with "/etc/app_protect/conf/" plus a file name with ".json" extension.
