...
- **Count of Resources:** the total count of resources related to NGINX Gateway Fabric. This includes `GatewayClasses`, `Gateways`, `HTTPRoutes`,`GRPCRoutes`, `TLSRoutes`, `TCPRoutes`, `UDPRoutes`, `InferencePool`, `Secrets`, `Services`, `BackendTLSPolicies`, `ClientSettingsPolicies`, `NginxProxies`, `ObservabilityPolicies`, `UpstreamSettingsPolicies`, `ProxySettingsPolicies`, `RateLimitPolicies`, `AuthenticationFilters` `SnippetsFilters`, `SnippetsPolicies`, `Endpoints`, `WAFPolicies`, and `ListenerSets`. The data within these resources is **not** collected.
