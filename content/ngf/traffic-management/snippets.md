...
f5-docs: DOCS-1848
f5-summary: >
  Snippets let advanced users insert NGINX directives into contexts generated by NGINX Gateway Fabric when Gateway API resources or first-class policies are not enough.
  Use SnippetsFilter for route-scoped changes and SnippetsPolicy for Gateway-scoped changes; snippets are disabled by default because invalid config can block reloads.
f5-description: "Insert advanced NGINX configuration into generated configs using SnippetsFilter and SnippetsPolicy."
f5-keywords: "NGINX Gateway Fabric, Snippets, SnippetsFilter, SnippetsPolicy, limit_conn, limit_except, custom NGINX config"
---
