...
| **controller.networkPolicy.enable** | Create a NetworkPolicy that targets the controller pods.  If enabled=true and both ingress and egress are empty, the resulting NetworkPolicy denies all ingress by default. | false |
