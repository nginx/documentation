...
If you are using NGINX Plus, get the NGINX Ingress Controller JWT and [create a license secret]({{< ref "/nic/install/license-secret.md" >}}).
...
- - [Download NGINX Ingress Controller from the F5 Registry]({{< ref "/nic/install/images/registry-download.md" >}}) topic.
- - [Add an NGINX Ingress Controller image to your cluster]({{< ref "/nic/install/images/add-image-to-cluster.md" >}})
- **Build your own image**: To build your own image, follow the [Build NGINX Ingress Controller]({{< ref "/nic/install/build.md" >}}) topic.
...
```shell
kubectl delete -f https://raw.githubusercontent.com/nginx/kubernetes-ingress/v{{< nic-version >}}/deploy/crds-nap-dos.yaml
```
