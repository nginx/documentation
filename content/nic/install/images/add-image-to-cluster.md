...
The page ["Installation with Manifests"]({{< ref "/nic/install/manifests.md" >}}) explains how to install NGINX Ingress Controller using manifests. The following snippet is an example of a deployment:
