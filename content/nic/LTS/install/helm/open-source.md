---
title: Use Helm to Install NGINX Ingress Controller LTS with NGINX Open Source
...
This page describes how to use Helm to install F5 NGINX Ingress Controller LTS with NGINX Open Source. 

It explains the requirements for NGINX Ingress Controller LTS, how to obtain and install the Helm chart, and what custom resource definitions (CRDs) are installed during the process.
...
To install NGINX Ingress Controller LTS using the OCI registry, run this command with your release name:
