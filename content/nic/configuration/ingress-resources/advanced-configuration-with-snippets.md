...
{{< call-out class="note" >}} If the NGINX configuration includes an invalid snippet, NGINX will continue to operate with the last valid configuration. {{< /call-out >}}
...
{{< call-out class="note" >}} The example is shortened for conciseness. {{< /call-out >}}
