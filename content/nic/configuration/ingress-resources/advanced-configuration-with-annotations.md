...
| *nginx.org/proxy-next-upstream*         | N/A                        | Sets the value of the [proxy_next_upstream](https://nginx.org/en/docs/http/ngx_http_proxy_module.html#proxy_next_upstream) directive.                                                                                                                                                                                                                                                                                                                                                                                                                                                | *N/A*                    |  |
| *nginx.org/proxy-next-upstream-timeout* | N/A                        | Sets the value of the [proxy_next_upstream_timeout](https://nginx.org/en/docs/http/ngx_http_proxy_module.html#proxy_next_upstream_timeout) directive.                                                                                                                                                                                                                                                                                                                                                                                                                                | *N/A*                    |  |
| *nginx.org/proxy-next-upstream-tries*   | N/A                        | Sets the value of the [proxy_next_upstream_tries](https://nginx.org/en/docs/http/ngx_http_proxy_module.html#proxy_next_upstream_tries) directive.                                                                                                                                                                                                                                                                                                                                                                                                                                    | *N/A*                    |  |
