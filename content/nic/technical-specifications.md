...
|Debian-based image with F5 WAF for NGINX and NGINX Agent 3 | ``debian:12-slim`` | F5 WAF for NGINX<br>NJS (NGINX JavaScript)<br>OpenTelemetry<br>NGINX Agent 3 | `nginx-ic-nap/nginx-plus-ingress:{{< nic-version >}}-agent` | amd64 |
...
|Debian-based image with F5 WAF for NGINX v5 and NGINX Agent 3 | ``debian:12-slim`` | F5 WAF for NGINX v5<br>NJS (NGINX JavaScript)<br>OpenTelemetry<br>NGINX Agent 3 | `nginx-ic-nap-v5/nginx-plus-ingress:{{< nic-version >}}-agent` | amd64 |
