...
| ---| ---| --- | --- | --- | --- |
|Debian-based image | ``debian:13-slim`` | NJS (NGINX JavaScript)<br>OpenTelemetry<br>Agent (NGINX Agent 3) | ``private-registry.nginx.com/nginx-ic/lts/nginx-plus-ingress:2026-lts-r1`` | arm64<br>amd64 | 5.4.x |
