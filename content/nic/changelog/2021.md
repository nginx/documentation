...
- If the Policy is marked as a preview feature in the [documentation]({{< ref "/nic/configuration/policy-resource/before-you-begin.md" >}}), make sure the -enable-preview-policies command-line argument is set in 2.0.0 Ingress Controller.
