...
- [4464](https://github.com/nginx/kubernetes-ingress/pull/4464) Allow default_server listeners to be customized.
...
- Added support for [fetching JWKs from a remote URL]({{< ref "/nic/configuration/policy-resource/policy-reference.md#jwt-using-jwks-from-a-remote-location" >}}) to dynamically validate JWT tokens and optimize performance through caching.
