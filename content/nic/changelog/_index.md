...
- Removed references to NGINX Service Mesh (NSM). NSM reached End of Life in March 2024 and is no longer supported. This does not affect NGINX Ingress Controller functionality. (#[PR 10432](https://github.com/nginx/kubernetes-ingress/pull/10432))
