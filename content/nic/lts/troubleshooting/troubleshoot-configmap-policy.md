...
This page describes how to troubleshoot NGINX Ingress Controller LTS Policy Resources.

## Policy Resources

After you create or update a Policy resource, you can use `kubectl describe` to check whether or not NGINX Ingress Controller LTS accepted the policy:
...
To verify the configuration applied, check the events of the [VirtualServer and VirtualServerRoute resources]({{< ref "/nic/lts/troubleshooting/troubleshoot-virtualserver.md" >}}) that reference the policy.
