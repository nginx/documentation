...
The table below outlines potential problems with NGINX Ingress Controller LTS when the App Protect DoS module is enabled. It suggests how to troubleshoot those problems with methods explained in the next section.

{{% table %}}

|Problem area | Symptom | Troubleshooting method | Common cause |
| ---| ---| ---| --- |
|Start | NGINX Ingress Controller LTS fails to start. | Check the NGINX Ingress Controller LTS logs. | Misconfigured DosProtectedResource, APDosLogConf or APDosPolicy. |
