---
title: Install NGINX Ingress Controller LTS and F5 WAF for NGINX with Docker and Helm
toc: true
weight: 200
...
1. Download your NGINX Ingress Controller LTS subscription's JSON Web Token, SSL Certificate, and Private Key from MyF5.
...
## Check compatibility between NGINX Ingress Controller LTS and F5 WAF for NGINX versions
...
Install the required CRDs for NGINX Ingress Controller LTS:
...
You now have a fully operational NGINX Ingress Controller LTS instance with F5 WAF for NGINX deployed in your Kubernetes environment.
