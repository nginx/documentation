...
- An [NGINX Ingress Controller LTS installation]({{< ref "/nic/install/" >}}) on the same host as an existing Ingress-NGINX Controller.
...
These code blocks show how the Ingress-NGINX annotations correspond to NGINX Ingress Controller LTS [VirtualServer and VirtualServerRoute resources]({{<ref "/nic/configuration/virtualserver-and-virtualserverroute-resources">}}).
