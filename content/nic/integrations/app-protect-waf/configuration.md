...
1. Follow the installation [instructions]({{< ref "/nic/integrations/app-protect-waf/installation.md" >}}) to deploy NGINX Ingress Controller with NGINX Plus and F5 WAF for NGINX.
