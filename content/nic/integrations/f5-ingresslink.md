...
The steps to enable the integration depend on the option chosen to install NGINX Ingress Controller: Using [Manifests]({{< ref "/nic/install/manifests" >}}) or using the [Helm chart]({{< ref "/nic/install/helm" >}}).
