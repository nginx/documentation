...
{{< call-out class="note" >}}Subrequests do not currently work when F5 WAF for NGINX is enabled. OIDC policies relying on subrequests are not supported when WAF is enabled.{{< /call-out >}}
