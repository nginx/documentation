...
f5-summary: >
  This reference covers the SSL/TLS certificate types and formats F5 Application Delivery Service for AWS supports, including post-quantum ML-DSA certificates, and the two ways to manage them: the F5 ADS Console and AWS Secrets Manager.
...
See [Enable post-quantum cryptography]({{< ref "/f5ads/aws/quickstart/pqc.md" >}}) for configuration guidance.
{{< /call-out >}}
