...
weight: 50
toc: true
url: /application-delivery-service/overview/nginx-configuration/configuration-rules/
...
You can upload NGINX configurations to your ${product} deployment using the F5 Application Delivery Service console:

- [Upload using the console]({{< ref "/ads/overview/nginx-configuration/nginx-configuration-console.md" >}})
...
If you need access to additional directories, please [contact us]({{< ref "/ads/support.md" >}}).
...
F5 Application Delivery Service reserves the following listen ports for internal use.
- `49151`
- `49152`

F5 Application Delivery Service does not support specific hostnames or IP addresses (other than localhost / loopback addresses) to be used as a `listen` address.
