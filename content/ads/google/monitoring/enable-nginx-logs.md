...
toc: true
f5-docs: DOCS-000
url: /application-delivery-service/google/monitoring/enable-nginx-logs/
...
{{< include "/ads/logging-config-security-logs.md" >}}
...
To disable sending logs to your Google Cloud project, update your F5 Application Delivery Service for Google Cloud deployment to remove the reference to your project ID. To update the deployment, in the F5 Application Delivery Service for Google Cloud console,
...
If Google Cloud Logging is not showing any logs, check for **Failed Log Export to Google** events from your F5 Application Delivery Service for Google Cloud deployment.
