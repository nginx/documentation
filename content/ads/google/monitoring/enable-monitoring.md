...
toc: true
f5-docs: DOCS-000
url: /application-delivery-service/google/monitoring/enable-monitoring/
...
- Configure Workload Identity Federation (WIF). See [our documentation on setting up WIF]({{< ref "/ads/google/deploy/access-management.md#configure-wif" >}}) for exact steps.
...
See the [Metrics Catalog]({{< ref "/ads/google/monitoring/metrics-catalog.md" >}}) for a full list of metrics F5 Application Delivery Service for Google Cloud provides.
...
To help you quickly visualize important metrics and logs from your F5 Application Delivery Service for Google Cloud deployments, you can import a pre-configured dashboard into Google Cloud Monitoring. The dashboard displays key metrics such as request and connection rates, response status codes, upstream health, and access and error logs.
...
```json
{
  "displayName": "F5 Application Delivery Service for Google Cloud",
  "dashboardFilters": [
    {
...
{{< call-out class="note" >}}The dashboard includes an **nginxaas_deployment_name** filter. Use this filter to view metrics for a specific F5 Application Delivery Service for Google Cloud deployment or select multiple deployments to compare their performance.{{< /call-out >}}

## Disable exporting F5 Application Delivery Service for Google Cloud metrics to a Google Cloud project

To disable sending metrics to your Google Cloud project, update your F5 Application Delivery Service for Google Cloud deployment to remove the reference to your project ID. To update the deployment, in the F5 Application Delivery Service for Google Cloud console,
...
If Google Cloud Monitoring is not showing any metrics, check for **Failed Metric Export to Google** events from your F5 Application Delivery Service for Google Cloud deployment.

In the F5 Application Delivery Service for Google Cloud console:

1. On the navigation menu, select **Events**.
1. Select **Add Filter**.
1. Select **Affected Object** and the name of your F5 Application Delivery Service for Google Cloud deployment.
