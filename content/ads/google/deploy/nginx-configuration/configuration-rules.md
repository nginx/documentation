...
weight: 50
toc: true
url: /application-delivery-service/google/deploy/nginx-configuration/configuration-rules/
f5-content-type: reference
f5-product: F5 Application Delivery Service for Google Cloud
contentSource: ads/overview/nginx-configuration/configuration-rules.md
---
...
You can upload NGINX configurations to your F5 Application Delivery Service for Google Cloud deployment using the Google Cloud console:

- [Upload using the console]({{< ref "/ads/google/deploy/nginx-configuration/nginx-configuration-console.md" >}})
...
If you need access to additional directories, please [contact us]({{< ref "/ads/google/support.md" >}}).
...
| debug_points        | F5 Application Delivery Service for Google Cloud does not provide access to NGINX processes for debugging. |
...
| ssl_ech_file     | F5 Application Delivery Service for Google Cloud does not use the [OpenSSL ECH feature branch](https://nginx.org/en/docs/http/ngx_http_ssl_module.html#ssl_ech_file). |
{{< /table >}}
...
| `pid` | `/run/nginx/nginx.pid` | Set to this value to allow F5 Application Delivery Service for Google Cloud to automatically manage the NGINX master process. |
| `daemon` | `on` | Automatically set to `on` to allow F5 Application Delivery Service for Google Cloud to manage the NGINX master process. |
...
F5 Application Delivery Service for Google Cloud supports a limited set of NGINX directives. The directives with the "app_protect" prefix require [F5 WAF for NGINX]({{< ref "/waf" >}}) to be enabled for the deployment.

F5 Application Delivery Service for Google Cloud does not yet support F5 WAF for NGINX custom security policies or logging profiles. Support is limited to the [prebuilt policies]({{< ref "/waf/policies/configuration.md#default-policy" >}}) and the [default logging profiles]({{< ref "/waf/logging/logs-overview.md#default-logging-profile-bundles" >}}).
