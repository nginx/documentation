...
1. Install the WAF compiler:
   ...
   ```shell
   sudo apt-get install nms-nap-compiler-v5.635.2
   ```
...
1. To install multiple compiler versions on the same system, append the `--force-overwrite` option after the first installation:
   ...
   ```shell
   sudo apt-get install nms-nap-compiler-v5.635.2 -o Dpkg::Options::="--force-overwrite"
   ```
...
1. Install the WAF compiler:
   ...
   ```shell
   sudo yum install nms-nap-compiler-v5.635.2
   ```
