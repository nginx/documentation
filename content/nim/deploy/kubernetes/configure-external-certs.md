...
nd-product: NIMNGR
description: "Configure NGINX Instance Manager to use external TLS certificates from a trusted CA instead of the self-signed certificates generated by the Helm chart."
...
summary: >
  Configure NGINX Instance Manager to use external TLS certificates for any or all of its services.
