...
F5 NGINX Instance Manager uses ClickHouse to store metrics, security events, and alerts only. All the remaining resources such as configs, certificates, secrets, templates and everything related are stored in dqlite memory.
