...
F5 NGINX Instance Manager uses ClickHouse to store metrics, Security events, alerts Only. All the remaining resources such as configs, certificates, secrets, templates and everything related are stored in dqlite memory.
