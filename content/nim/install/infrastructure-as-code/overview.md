...
- An NGINX repository certificate and key. For instructions on how to download them, click [here]({{< ref "/nim/install/vm-bare-metal/install-with-bash-script-online.md#download-cert-key" >}}).
