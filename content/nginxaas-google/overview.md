...
Here are the current constraints to keep in mind while using NGINXaaS for Google Cloud:

- At this time, we support a limited number of geographies and regions. However, we are continually working to expand support across additional regions.
