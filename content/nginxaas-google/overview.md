...
At present, there are some constraints to be aware of regarding NGINXaaS for Google Cloud. We are actively working to enhance the offering, and many of these constraints may evolve over time as we expand and enhance our service.

- At this time, we support a limited number of geographies and regions. However, we are continually working to expand support across additional locations.
