...
Once you have completed the subscription process, you can access the NGINX as a Service portal by selecting **Manage on provider** or by going to [https://console.nginxaas.net/](https://console.nginxaas.net/).
