...
1. Click **Subscribe**, and a message will confirm that your order request was sent to F5, Inc. The automatic approval process takes a few seconds. Next, click **Sign up with F5, Inc.** to proceed. In the "Welcome to F5 NGINXaaS for Google Cloud" window, click **Close Window** to return to the Google Cloud Console.
