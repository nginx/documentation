...
If you can’t see metrics in Google Cloud Monitoring, check for **Failed Metric Export to Google** events from your NGINXaaS deployment.
...
Events are retained for 14 days and then deleted. 
